...
macro_rules! init_open_skel {
    ($skel: expr, $opts: expr, $verbose: expr) => {
        'block: {
            ...
            $skel.maps.rodata_data.topo_config.smt_enabled = $crate::TOPO.smt_enabled;
            $skel.maps.rodata_data.topo_config.has_little_cores = $crate::TOPO.has_little_cores();
            ...
            $skel.maps.rodata_data.timeline_config.autoslice = opts.autoslice;
            ...
            $skel.maps.rodata_data.lb_config.max_dsq_pick2 = opts.max_dsq_pick2;
            $skel.maps.rodata_data.lb_config.eager_load_balance = !opts.eager_load_balance;
            $skel.maps.rodata_data.lb_config.dispatch_pick2_disable = opts.dispatch_pick2_disable;
            $skel.maps.rodata_data.lb_config.dispatch_lb_busy = opts.dispatch_lb_busy;
            $skel.maps.rodata_data.lb_config.dispatch_lb_interactive = opts.dispatch_lb_interactive;
            $skel.maps.rodata_data.lb_config.wakeup_lb_busy = opts.wakeup_lb_busy;
            $skel.maps.rodata_data.lb_config.wakeup_llc_migrations = opts.wakeup_llc_migrations;
            ...
            $skel.maps.rodata_data.p2dq_config.kthreads_local = !opts.disable_kthreads_local;
            ...
            $skel.maps.rodata_data.p2dq_config.freq_control = opts.freq_control;
            $skel.maps.rodata_data.p2dq_config.interactive_sticky = opts.interactive_sticky;
            $skel.maps.rodata_data.p2dq_config.interactive_fifo = opts.interactive_fifo;
            $skel.maps.rodata_data.p2dq_config.keep_running_enabled = opts.keep_running;
            $skel.maps.rodata_data.p2dq_config.select_idle_in_enqueue = opts.select_idle_in_enqueue;
